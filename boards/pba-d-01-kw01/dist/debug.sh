...
echo PBA-D-01-KW01 Debug script executed

openocd -f"../../boards/pba-d-01-kw01/dist/mkw01z128.cfg" \ #"${RIOTBOARD}/${BOARD}/dist/mkw01d128.cfg" \
    -c "tcl_port 6333" \
    -c "telnet_port 4444" \
    -c "init" \
    -c "targets" \
...
echo $retval
echo "Fcfield not fitting to MKW01Z128, danger of bricking the device during flash...[abort]"
fi
kill ${OCD_PID}
