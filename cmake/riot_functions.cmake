...
function(add_riot_module module_name)
  ...
  string(MAKE_C_IDENTIFIER "${module_name}" module_name_c)
  set(prefixed_name "riot_module_${module_name}")
  message(VERBOSE "Creating RIOT module target ${prefixed_name}")
  add_library(${prefixed_name}_sources INTERFACE)
  target_sources(${prefixed_name}_sources INTERFACE ${ARGN})
  #target_link_libraries(${prefixed_name}_sources INTERFACE RIOT::flags)
  add_library(${prefixed_name}_flags INTERFACE)
  target_compile_definitions(${prefixed_name}_flags INTERFACE MODULE_${module_name_c})
  set_property(TARGET ${prefixed_name}_sources APPEND PROPERTY INTERFACE_RIOT_USEMODULE ${module_name})
